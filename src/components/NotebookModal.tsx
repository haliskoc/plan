...
const COVER_OPTIONS: { id: CoverStyle; name: string; desc: string; previewClass: string }[] = [
  {
    id: "modern-indigo",
    name: "Modern Indigo",
    desc: "Koyu mavi ve neon indigo detaylı modern kapak.",
    previewClass: "bg-slate-950 border border-indigo-500/30 flex flex-col justify-between p-2 text-white",
  },
  {
    id: "creative-sunset",
    name: "Creative Sunset",
    desc: "Sıcak gün batımı renk geçişli estetik kapak.",
    previewClass: "bg-neutral-900 border border-orange-500/20 relative overflow-hidden flex flex-col justify-between p-2 text-white",
  },
  {
    id: "minimalist-slate",
    name: "Minimalist Slate",
    desc: "Kalın çerçeveli, sade ve şık antrasit kapak.",
    previewClass: "bg-slate-100 border-4 border-slate-600 flex flex-col justify-between p-2 text-slate-800",
  },
  {
    id: "academic-classic",
    name: "Academic Classic",
    desc: "Klasik defter çerçeveli ve şeritli retro kapak.",
    previewClass: "bg-amber-50/50 border border-amber-900/60 flex flex-col justify-between p-2 text-amber-900",
  },
  {
    id: "optical-clean",
    name: "Optical Clean",
    desc: "Sınav formu görünümlü teknik kodlama kapağı.",
    previewClass: "bg-white border-2 border-black flex flex-col justify-between p-2 text-black",
  },
  {
    id: "none",
